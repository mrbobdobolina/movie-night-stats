...
<div class="row g-3  mb-3">
	...
	<?php foreach($event_list->events() as $event): ?>
		<div class="card col-lg-12 p-0" >
			<div class="card-header pt-2 pb-1 text-white lead" style="background-color:#<?php echo $event->winner['viewer']->color; ?>">
		  ...
		  <div class="row row-cols-12 row-cols-lg-12 g-1 g-lg-2 px-1">
				<?php for($i = 1; $i <= 12; $i++):?>
					...
					<?php if($event->wedges[$i]['media']->id != 0): ?>
						<i class="fas fa-film-alt" style="color:#<?php echo $event->wedges[$i]['viewer']->color; ?>"></i>

						<img src="<?php echo $event->wedges[$i]['media']->poster_url_or_bust(); ?>" class="img-fluid poster" alt="<?php echo $event->wedges[$i]['media']->name; ?>">
