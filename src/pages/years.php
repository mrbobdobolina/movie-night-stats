				...
				<table id="column-years" class="charts-css column show-labels show-data">
					...
					<?php foreach ($yearly_events as $key => $value): ?>
						<tr>
							...
							<td style="--size:<?php echo round($value / $max_events, 2); ?>;">
			...
			<div class="card-body">
				...
				<table id="column-years" class="charts-css column show-labels show-data">
					...
					<?php foreach ($yearly_time as $key => $value): ?>
						<tr>
							<th scope="row"><?php echo $key; ?> </th>
							<td style="--size:<?php echo round($value / $max_time, 2); ?>;">
								<span class="data"><?php echo $value; ?></span></td>
						</tr>
					<?php endforeach; ?>
					</tbody>
			...
			<div class="card-body">
				...
				<table id="column-years" class="charts-css column show-labels show-data">
					...
					<?php foreach ($yearly_attendance as $key => $value): ?>
						<tr>
							<th scope="row"><?php echo $key; ?> </th>
							<td style="--size:<?php echo round($value / $max_attendance, 2); ?>;">
								<span class="data"><?php echo $value; ?></span></td>
						</tr>
					<?php endforeach; ?>
					</tbody>
