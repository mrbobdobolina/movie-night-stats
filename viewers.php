    ...
    <div class="container">
				  ...
				  <thead>
				    <tr>
				      ...
				      <th class="text-end">
							...
							<th aria-sort="ascending">Last Spin</th>
							<th>
						...
						<?php foreach($viewer as $person): ?>
					    	...
					    	<td style="background-color:#<?php echo $person['color'];?>;" class="bold text-white"><?php echo $person['name'];?></td>
					     	...
					     	<td class="text-end"><?php echo $attend;?></td>
								...
								<?php $myUnique = calculateMyUniquePicks($person['id']);;
								...
								<?php $spins = countMySpins_noChoice($person['id']); ?>
								<td class="text-end"><?php echo $spins['total'];?></td>
								<?php $picks = countMySpins($person['id']); ?>
			...
			<div class="row row-cols-1 row-cols-md-2 row-cols-md-2 row-cols-xl-3 g-3 mt-5">
	          ...
	          <div class="card">
	            ...
	            <div class="card-body">
								<ul>
									<li><strong>Spun Numbers: </strong><?php //echo implode(", ", listOfSpunNumbersByViewer($person['id']));?></li>
