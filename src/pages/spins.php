			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="">
						...
						<p>*Red indicates an error. An error occurs when the winning movie is not available to be
							watched
		...
		<div class="col m-5">
				...
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<p class="card-text">Wheel version 1 was made from a $3 clock in the entrance of target and
								a
								fidget spinner bearing. Small brad nails were used as pegs and the flipper was crafted
								from
								hardwood. Version 1.0 broke on it's first spin. Several brad nails were dislodged upon
								contact with the flipper. The flipper also broke. The original flipper was replaced with
								a
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<p class="card-text">Wheel version 2 was build using a piece of plywood. It was used for 17
								spins before it was found to be weighted and most likely to land on the number 8. While
								it
								may be possible to reblance the wheel at some point, no efforts have been made at this
								time.
							</p>
						</div>
					</div>
				...
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<p class="card-text">Wheel version 3 was designed using particleboard, which should have a
								more
								uniform density than plywood. It used a similar flipper and axel to the other two. It
								was
								designed to be 18 inches in diameter, which became an issue when drilling the center
								hole.
								The wheel is heavy and does not sit level as it rotates. The balance was fine-tuned
								using
								tacks along the perimeter, though the level of balance is still being debated. Wheel 3
								broke
				...
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<p class="card-text">A single 12-sided die is often used. There is no single die designated
								for
			...
			<div class="card mb-4">
				<div class="row g-0">
					<div class="col-md-4">
						<img
							src="../images/wheels/viewerchoice.jpg" class="img-fluid rounded-start" alt="Viewer Choice">
					</div>
					<div class="col-md-8">
						<div class="card-body">
							...
							<p class="card-text">Occasionally we decide it's better not to leave things up to chance.
								Typically this means only one person is present for movie night or everyone attending
								wants
				...
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<p class="card-text">Random.org offers several different features for choosing items
								randomly.
							</p>
						</div>
					</div>
				...
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<p class="card-text">This spinning die is from <a href="https://www.pyegames.com/">PYE
									Games</a>.
							</p>
						</div>
					</div>
			...
			<div class="card mb-4">
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							<h5 class="card-title fw-bold"><a href="https://movienightstats.com/roll/">Digital D12</a>
							</h5>
