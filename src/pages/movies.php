...
<div class="row">
	<p>
		<i class="fas fa-star p-1" style="color:#FFFF00;background-color:#82D173;"></i> Indicates movie was (randomly)
		spun its first night on the wheel. <i
			class="fas fa-hand-point-down p-1"
			style="color:#FFFF00;background-color:#82D173;"></i> Indicated movie was picked (viewer choice) its first
		night on the wheel. <span style="background-color:#82D173;">Green row indicates movie won at least once.</span>
	</p>
	...
	<div class="row justify-content-around">
		<div class="alert alert-warning text-center col-5">
			<p> We've had a total of <?php echo $oneHitWonders; ?> "One Hit Wonders". <br />(Movies picked randomly on
