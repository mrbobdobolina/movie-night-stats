...
<div class="row">
	<div class="col-12">
		<h1 class="alert text-white text-center fw-bold" style="background-color:#<?php echo $this_viewer->color; ?>">
					...
					<ul class="list-group list-group-flush">
						...
						<li class="list-group-item">
							<div class="row">
								...
								<div class="col"><?php echo $this_viewer_stats['attendance'][0]->date->short(); ?></div>
							</div>
						</li>
					</ul>
				</div>
