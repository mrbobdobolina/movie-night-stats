...
<p class="display-6 text-center mt-4">Yes! We made a website for this.</p>
...
<div class="row justify-content-center">
	<div class=" col-lg-2">
		<button
			id="btn-expand-all"
			class="btn btn-sm btn-outline-primary mb-3 col-8"
		...
		<a href="/events/table" class="btn btn-sm btn-outline-secondary mb-3 col-8">
			<i class="fa-solid fa-table"></i> Table View
		</a>
		<a href="/events/rows" class="btn btn-sm btn-outline-secondary mb-3 col-8">
			<i class="fa-solid fa-images"></i> Poster View
		</a>
		<a href="/events/posters" class="btn btn-sm btn-outline-secondary mb-3 col-8">
			<i class="fa-solid fa-image-portrait"></i> Winning Poster
		</a>
					...
					<div class="collapse" id="collapseExample_<?php echo $count_events; ?>">
						<div class="card card-body">
							...
							<ul>
								...
								<li><strong>Winning Movie Year:</strong> <?php echo $event->winner['media']->year; ?>
								</li>
							</ul>
						</div>
					</div>
