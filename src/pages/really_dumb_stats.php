<div class="row mt-3 mb-3">
	<div class="col">
		...
		<p class="lead text-center mb-5">I don't know what you're trying to prove except maybe that you need something
					...
					<table id="wedge_time" class="charts-css column show-labels show-data">
						...
						for ($ii = 1; $ii <= 12; $ii++): ?>
							...
							<tr>
								...
								<td style="--size:<?php echo round($total_runtime / $max, 2); ?>; ">
									<span class="data data_padding"><?php echo $total_runtime; ?></span></td>
							</tr>
						<?php endfor; ?>
						</tbody>
					</table>
						...
						<table id="columns" class="charts-css column show-labels">
							...
							<?php foreach ($viewer_time as $key => $value): ?>
								<tr>
									...
									<td style="--size:<?php echo round($value / $max, 2); ?>; --color:#<?php echo getMoviegoerColorById($key); ?>">
